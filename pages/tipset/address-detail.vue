...
<!--    &lt;!&ndash;矿工详情&ndash;&gt;-->
<!--    <miner-detail v-if="type === 3" />-->
<!--    &lt;!&ndash;般账户详情&ndash;&gt;-->
<!--    <general-detail v-else />-->
  </div>
</template>
<script>
import mixin from '@/bu-components/address/mixin'
// import GeneralDetail from '@/bu-components/address/generalDetail'
    ...
    async getAddressInfo(address) {
      ...
      if(res.basic){
        ...
        if(actor_type===3){
          ...
          this.$router.replace('/address/general?address='+address)
        }
      }
    }
  },
